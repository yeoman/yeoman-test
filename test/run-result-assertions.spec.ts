    ...
    describe(testFs.description, () => {
      ...
      describe('.assertFile()', () => {
        ...
        it('accept an array of files all of which exist', () => {
          assert.doesNotThrow(yoAssert.assertFile.bind(yoAssert, ['testFile', 'testFile2']));
        });
        ...
        it('reject multiple files one of which does not exist', () => {
          assert.throws(yoAssert.assertFile.bind(yoAssert, ['testFile', 'intangibleTestFile']));
        });
      });
      ...
      describe('.assertNoFile()', () => {
        ...
        it('accept an array of files all of which do not exist', () => {
          assert.doesNotThrow(yoAssert.assertNoFile.bind(yoAssert, ['etherealTestFile', 'intangibleTestFile']));
        });
        ...
        it('reject an array of files one of which exists', () => {
          assert.throws(yoAssert.assertNoFile.bind(yoAssert, ['testFile', 'etherealTestFile']));
        });
      });

      describe('.assertFileContent()', () => {
        it('accept a file and regex when the file content matches the regex', () => {
          assert.doesNotThrow(yoAssert.assertFileContent.bind(yoAssert, 'testFile', /Roses are red/));
        });
        ...
        it('reject a file and regex when the file content does not match the regex', () => {
          assert.throws(yoAssert.assertFileContent.bind(yoAssert, 'testFile', /Roses are blue/));
        });
      ...
      describe('.assertEqualsFileContent()', () => {
        it('accept a file and string when the file content equals the string', () => {
          assert.doesNotThrow(yoAssert.assertEqualsFileContent.bind(yoAssert, 'testFile', 'Roses are red.\n'));
        });

        it('reject a file and string when the file content does not equal the string', () => {
          assert.throws(yoAssert.assertEqualsFileContent.bind(yoAssert, 'testFile', 'Roses are red'));
        });
      ...
      describe('.assertNoFileContent()', () => {
        it('accept a file and regex when the file content does not match the regex', () => {
          assert.doesNotThrow(yoAssert.assertNoFileContent.bind(yoAssert, 'testFile', /Roses are blue/));
        });
        ...
        it('reject a file and regex when the file content matches the regex', () => {
          assert.throws(yoAssert.assertNoFileContent.bind(yoAssert, 'testFile', /Roses are red/));
        });
      ...
      describe('.assertTextEqual()', () => {
        it('pass with two similar simple lines', () => {
          assert.doesNotThrow(yoAssert.assertTextEqual.bind(yoAssert, 'I have a yellow cat', 'I have a yellow cat'));
        });

        it('fails with two different simple lines', () => {
          assert.throws(yoAssert.assertTextEqual.bind(yoAssert, 'I have a yellow cat', 'I have a brown cat'));
        });

        it('pass with two similar simple lines with different new line types', () => {
          assert.doesNotThrow(yoAssert.assertTextEqual.bind(yoAssert, 'I have a\nyellow cat', 'I have a\r\nyellow cat'));
        });
      });
      ...
      describe('.assertJsonFileContent()', () => {
        ...
        it('fails if file does not exists', () => {
          assert.throws(yoAssert.assertJsonFileContent.bind(yoAssert, 'does-not-exist', {}));
        });
      });
      ...
      describe('.assertNoJsonFileContent()', () => {
        ...
        it('fails if file does not exists', () => {
          assert.throws(yoAssert.assertNoJsonFileContent.bind(yoAssert, 'does-not-exist', {}));
        });
      });
    });
  }
